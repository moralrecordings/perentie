 ...
 */
static const uint8_t perm[256] = { 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103,
 ...
 */
static float grad_1d(int32_t hash, float x)
{
 ...
 * @return gradient value
 */
static float grad_2d(int32_t hash, float x, float y)
{
 ...
 * @return gradient value
 */
static float grad_3d(int32_t hash, float x, float y, float z)
{
...
float simplex_noise_1d(float x)
{
    ...
    t0 *= t0;
    n0 = t0 * t0 * grad_1d(hash(i0), x0);

    // Calculate the contribution from the second corner
    float t1 = 1.0f - x1 * x1;
    //  if(t1 < 0.0f) t1 = 0.0f; // not possible
    t1 *= t1;
    n1 = t1 * t1 * grad_1d(hash(i1), x1);
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float simplex_fractal_1d(float frequency, float amplitude, float lacunarity, float persistence, size_t octaves, float x)
{
    float output = 0.f;
    float denom = 0.f;
